"""Generate deterministic endpoint summary for Creator OAS inputs."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--openapi", type=Path, action="append", required=True)
...
def main() -> int:
    args = parse_args()
    endpoints = load_creator_endpoints(args.openapi)
